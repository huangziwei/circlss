...
the reference implementation for the architecture. The remaining
circular families (wrapped Cauchy, projected normal, Jones–Pewsey,
sine-skewed JP, cardioid, Cartwright, wrapped normal, Kato–Jones) follow
in v0.1.0, ported from
...
[`vmlss()`](https://huangziwei.github.io/circlss/reference/vmlss.md) is
an mgcv *general family*: pass
